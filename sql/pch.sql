...
CREATE TABLE `message` (
  ...
  KEY `fk_message_candidate` (`candidate_id`),
  KEY `fk_message_company` (`company_id`),
  CONSTRAINT `fk_message_candidate` FOREIGN KEY (`candidate_id`) REFERENCES `candidate` (`id_candidate`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_message_company` FOREIGN KEY (`company_id`) REFERENCES `company` (`id_company`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-21  8:03:59
