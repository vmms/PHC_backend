...
class Candidate(models.Model):
    ...
    adult = models.BooleanField(null=True, blank=True, default=None)
    work_permission = models.BooleanField(null=True, blank=True, default=None)
    ...
    servsafe = models.CharField(max_length=25, null=True, blank=True, default=None)
